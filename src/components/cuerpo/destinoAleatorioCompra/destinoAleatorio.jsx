...
function DestinoAleatorio(props) {
    ...
    return (
        <>
            <div className="bg-[rgba(169,169,169,0.3)] grid  mx-28 gap-4 md:flex md:flex-wrap md:justify-center md:items-center md:space-x-5 md:p-4 border-solid border-amber-700 border-1 rounded-xl ">
                <div>
